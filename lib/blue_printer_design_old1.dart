...
class BluePrinterDesignOld1 extends StatefulWidget {
  const BluePrinterDesignOld1({super.key});

  @override
  State<BluePrinterDesignOld1> createState() => _BluePrinterDesignOld1State();
}

class _BluePrinterDesignOld1State extends State<BluePrinterDesignOld1> {
          ...
          child: Column(
            ...
            children: [
              ...
              Table(
                border: TableBorder.all(),
                columnWidths: const {
                  2: FixedColumnWidth(60), // Shrink "Tax" column width
                },
                children: [
                  TableRow(
                    decoration: BoxDecoration(color: Colors.grey[200]),
